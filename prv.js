   ...
   item.forEach(element => {
        ...
        element['items'].every(element1 =>{
            ...
            if(element['bundle'] == undefined)
            {
                ...
                new_dict['itemRarityPicture'] = rarity_color
        ...
        if(element['bundle'] != undefined)
        {
            ...
            images_in_bundle.unshift({imageSrc : bundleImage, caption : itemDescription, itemRarityPicture : '#f3af19'})
            if(img.src.includes("null"))
            {
                img.src = element1['images']['icon'];
            }
            ...
            image.style.backgroundColor = slide.itemRarityPicture
